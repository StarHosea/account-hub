import { Switch, Button, Typography, Space, Tag, Tooltip } from "@douyinfe/semi-ui-19";
  ...
  return (
    <Space align="center" spacing={12}>
      <Space align="center" spacing={6}>
        ...
        <Switch checked={running} loading={isSaving} onChange={() => void toggle()} aria-label="启动/停止注册机" />
      </Space>
